<!-- 来源: api_reference\main\block\_autosummary\keysight.pwdatatools.Block.name.html -->
...
* [Main](../../index.md)
* [Block](../index.md)
* keysight.pwdatatools.Block.name
...
[*code* Source](../../../../_sources/api_reference/main/block/_autosummary/keysight.pwdatatools.Block.name.rst.txt)
...
# keysight.pwdatatools.Block.name[](#keysight-pwdatatools-block-name "Link to this heading")

*property* Block.name*: str*[](#keysight.pwdatatools.Block.name "Link to this definition")
:   A str name for the Block.
