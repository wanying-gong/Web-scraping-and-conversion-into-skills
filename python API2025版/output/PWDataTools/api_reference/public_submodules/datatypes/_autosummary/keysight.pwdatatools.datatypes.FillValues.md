<!-- 来源: api_reference\public_submodules\datatypes\_autosummary\keysight.pwdatatools.datatypes.FillValues.html -->
...
* [datatypes](../index.md)
* keysight.pwdatatools.datatypes.FillValues
...
[*code* Source](../../../../_sources/api_reference/public_submodules/datatypes/_autosummary/keysight.pwdatatools.datatypes.FillValues.rst.txt)
...
* [API Reference](../../../index.md)
  ...
  + [Public Submodules](../../index.md)
    ...
    - [datatypes](../index.md)
      * [keysight.pwdatatools.datatypes.Boolean](keysight.pwdatatools.datatypes.Boolean.md)
      * [keysight.pwdatatools.datatypes.Complex64](keysight.pwdatatools.datatypes.Complex64.md)
      * [keysight.pwdatatools.datatypes.Complex128](keysight.pwdatatools.datatypes.Complex128.md)
      * [keysight.pwdatatools.datatypes.DataType](keysight.pwdatatools.datatypes.DataType.md)
      * keysight.pwdatatools.datatypes.FillValues
      * [keysight.pwdatatools.datatypes.Float32](keysight.pwdatatools.datatypes.Float32.md)
      * [keysight.pwdatatools.datatypes.Float64](keysight.pwdatatools.datatypes.Float64.md)
      * [keysight.pwdatatools.datatypes.Int8](keysight.pwdatatools.datatypes.Int8.md)
      * [keysight.pwdatatools.datatypes.Int16](keysight.pwdatatools.datatypes.Int16.md)
      * [keysight.pwdatatools.datatypes.Int32](keysight.pwdatatools.datatypes.Int32.md)
      * [keysight.pwdatatools.datatypes.Int64](keysight.pwdatatools.datatypes.Int64.md)
      * [keysight.pwdatatools.datatypes.String](keysight.pwdatatools.datatypes.String.md)
      * [keysight.pwdatatools.datatypes.UInt8](keysight.pwdatatools.datatypes.UInt8.md)
      * [keysight.pwdatatools.datatypes.UInt16](keysight.pwdatatools.datatypes.UInt16.md)
      * [keysight.pwdatatools.datatypes.UInt32](keysight.pwdatatools.datatypes.UInt32.md)
      * [keysight.pwdatatools.datatypes.UInt64](keysight.pwdatatools.datatypes.UInt64.md)
      * keysight.pwdatatools.datatypes.FillValues
  ...
  + [Data Types](../../../datatypes.md)
    - [Boolean](keysight.pwdatatools.datatypes.Boolean.md)
    - [Complex64](keysight.pwdatatools.datatypes.Complex64.md)
    - [Complex128](keysight.pwdatatools.datatypes.Complex128.md)
    - [DataType](keysight.pwdatatools.datatypes.DataType.md)
    - FillValues
    - [Float32](keysight.pwdatatools.datatypes.Float32.md)
    - [Float64](keysight.pwdatatools.datatypes.Float64.md)
    - [Int8](keysight.pwdatatools.datatypes.Int8.md)
    - [Int16](keysight.pwdatatools.datatypes.Int16.md)
    - [Int32](keysight.pwdatatools.datatypes.Int32.md)
    - [Int64](keysight.pwdatatools.datatypes.Int64.md)
    - [String](keysight.pwdatatools.datatypes.String.md)
    - [UInt8](keysight.pwdatatools.datatypes.UInt8.md)
    - [UInt16](keysight.pwdatatools.datatypes.UInt16.md)
    - [UInt32](keysight.pwdatatools.datatypes.UInt32.md)
    - [UInt64](keysight.pwdatatools.datatypes.UInt64.md)
...
# keysight.pwdatatools.datatypes.FillValues[](#keysight-pwdatatools-datatypes-fillvalues "Link to this heading")

*class* FillValues(*boolean: bool = True*, *complexfloating: complex = nan + nanj*, *floating: float = nan*, *integer: int = 999999*, *string: str = 'null'*)[](#keysight.pwdatatools.datatypes.FillValues "Link to this definition")
:   Define fill values for masked data.

    \_\_init\_\_(*boolean: bool = True*, *complexfloating: complex = nan + nanj*, *floating: float = nan*, *integer: int = 999999*, *string: str = 'null'*)[](#keysight.pwdatatools.datatypes.FillValues.__init__ "Link to this definition")
    ...
    |  |  |
    | --- | --- |
    | [`__init__`](#keysight.pwdatatools.datatypes.FillValues.__init__ "keysight.pwdatatools.datatypes.FillValues.__init__")([boolean, complexfloating, ...]) | Initialize FillValues instance. |
    | `get_fill_value`(dtype) | Return fill value for the specified DataType. |
    | `replace`(\*\*kwargs) | Return new instance with any specified values replaced. |

    Attributes

    |  |  |
    | --- | --- |
    | `boolean` | Fill value for boolean data. |
    | `complexfloating` | Fill value for complex data. |
    | `floating` | Fill value for float data. |
    | `integer` | Fill value for integer data. |
    | `string` | Fill value for string data. |
