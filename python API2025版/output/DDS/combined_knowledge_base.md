# DDS Python Documentation Knowledge Base
> 本文件由 MarkItDown 自动转换，BFS 遍历自 Keysight ADS2025 Update 2 DDS Python Documentation HTML 文档。
> 共 68 个页面。
...
6. [concepts\index.md](#concepts--index)
7. [concepts\execution.md](#concepts--execution)
8. [reference\index.md](#reference--index)
9. [reference\dds\index.md](#reference--dds--index)
10. [reference\dds\file.md](#reference--dds--file)
11. [reference\dds\page.md](#reference--dds--page)
12. [reference\dds\point.md](#reference--dds--point)
13. [reference\dds\rect.md](#reference--dds--rect)
14. [reference\dds\grid.md](#reference--dds--grid)
15. [reference\dds\plots.md](#reference--dds--plots)
16. [reference\dds\axes.md](#reference--dds--axes)
17. [reference\dds\legend.md](#reference--dds--legend)
18. [reference\dds\trace.md](#reference--dds--trace)
19. [reference\dds\marker.md](#reference--dds--marker)
20. [reference\dds\linemarker.md](#reference--dds--linemarker)
21. [reference\dds\limitlines.md](#reference--dds--limitlines)
22. [reference\dds\masks.md](#reference--dds--masks)
23. [reference\dds\specifications.md](#reference--dds--specifications)
24. [reference\dds\equation.md](#reference--dds--equation)
25. [reference\dds\pyequation.md](#reference--dds--pyequation)
26. [reference\dds\text.md](#reference--dds--text)
27. [reference\dds\picture.md](#reference--dds--picture)
28. [reference\dds\shapes.md](#reference--dds--shapes)
29. [reference\dds\group.md](#reference--dds--group)
30. [reference\dds\basic.md](#reference--dds--basic)
31. [reference\dds\print.md](#reference--dds--print)
32. [reference\dds\objects.md](#reference--dds--objects)
33. [reference\dds\windows.md](#reference--dds--windows)
34. [reference\dds\pywidget.md](#reference--dds--pywidget)
35. [reference\dds\experimental\index.md](#reference--dds--experimental--index)
36. [reference\dds\app\index.md](#reference--dds--app--index)
37. [reference\dds\app\addon.md](#reference--dds--app--addon)
38. [reference\dds\app\callbacks.md](#reference--dds--app--callbacks)
39. [howto\index.md](#howto--index)
40. [howto\venv.md](#howto--venv)
41. [howto\newvenv.md](#howto--newvenv)
42. [howto\existingvenv.md](#howto--existingvenv)
43. [howto\pytest.md](#howto--pytest)
44. [examples\index.md](#examples--index)
45. [examples\ex_shapes.md](#examples--ex_shapes)
46. [examples\ex_pages_and_windows.md](#examples--ex_pages_and_windows)
47. [examples\ex_modified_file.md](#examples--ex_modified_file)
48. [examples\ex_markers.md](#examples--ex_markers)
49. [examples\ex_line_markers.md](#examples--ex_line_markers)
50. [examples\ex_expressions_and_dataframes.md](#examples--ex_expressions_and_dataframes)
51. [examples\ex_simple.md](#examples--ex_simple)
52. [examples\ex_optimized_amp.md](#examples--ex_optimized_amp)
53. [examples\ex_python_equations.md](#examples--ex_python_equations)
54. [examples\ex_specifications.md](#examples--ex_specifications)
55. [examples\ex_trantest.md](#examples--ex_trantest)
56. [examples\ex_crq_extraction.md](#examples--ex_crq_extraction)
57. [examples\ex_custom_menu.md](#examples--ex_custom_menu)
58. [examples\ex_print.md](#examples--ex_print)
59. [appExamples\index.md](#appexamples--index)
60. [appExamples\ex_custom_menu.md](#appexamples--ex_custom_menu)
61. [appExamples\ex_page_widget.md](#appexamples--ex_page_widget)
62. [appExamples\ex_matplotlib_widget.md](#appexamples--ex_matplotlib_widget)
63. [appExamples\ex_addon.md](#appexamples--ex_addon)
64. [addonExamples\index.md](#addonexamples--index)
65. [addonExamples\ex_addon\init.md](#addonexamples--ex_addon--init)
66. [addonExamples\ex_addon_3d_plot\index.md](#addonexamples--ex_addon_3d_plot--index)
67. [addonExamples\ex_addon_3d_plot\init.md](#addonexamples--ex_addon_3d_plot--init)
68. [addonExamples\ex_addon_3d_plot\ex_addon_3d_plot.md](#addonexamples--ex_addon_3d_plot--ex_addon_3d_plot)
...
# DDS Python documentation[](#dds-python-documentation "Link to this heading")
...
mw = app.get_pyside2_main_window(dds_file.windows[0])
mb = mw.menuBar()
...
mainwindow = app.get_pyside2_main_window(cur_file.windows[0])
view = mainwindow.centralWidget()

locked_button = PySide2.QtWidgets.QPushButton(parent=view, text="Toggle Activate 1")
locked_button.clicked.connect(myclick)
locked_button.move(view.width() - locked_button.width() - 100, 0)
locked_button.show()

panning_button = PySide2.QtWidgets.QPushButton(parent=view, text="Toggle Activate 2")
panning_button.clicked.connect(myclick)
panning_button.show()
page.add_widget(panning_button, dds.Point(3000, 3000))

resizing_button = PySide2.QtWidgets.QPushButton(parent=mainwindow.centralWidget(), text="Toggle Activate 3")
...
page = file.pages[0]
mw = app.get_pyside2_main_window(file.windows[0])
plot = PlotWidget()
