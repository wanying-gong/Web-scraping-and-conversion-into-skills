...
> 本知识库来自 Keysight ADS 2025 Update 2 EDA Toolbox API Documentation HTML 文档，经 MarkItDown 转换并按主题自动分类整理，专为 AI Agent 按需加载设计。
...
| 文件 | 内容 | 大小 |
|------|------|------|
| `01_root.md` | Root | ~16 KB |
| `02_api_reference.md` | Api Reference | ~47 KB |
| `03_examples.md` | Examples | ~1 KB |
...
原始转换文件保存在 `D:\MarkitdownFull\output\EDAToolbox` 目录下（按原 HTML 目录结构镜像），可用于查阅具体细节。本 `skills/` 目录下的文件是按主题合并的精简版本。
