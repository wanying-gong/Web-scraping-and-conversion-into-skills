...
> 本文件由 MarkItDown 自动转换，BFS 遍历自 Keysight ADS2025 Update 2 ADS Dataset Documentation HTML 文档。
> 共 5 个页面。
...
keysight.ads.dataset.open(*path: [PathLike](https://docs.python.org/3/library/os.md#os.PathLike "(in Python v3.13)")*, *mode: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") = 'r'*) → [Dataset](#keysight.ads.dataset.Dataset "keysight.ads.dataset.Dataset")[](#keysight.ads.dataset.open "Link to this definition")
...
keysight.ads.dataset.open\_dataset\_for\_reading(*path: [PathLike](https://docs.python.org/3/library/os.md#os.PathLike "(in Python v3.13)")*) → [Dataset](#keysight.ads.dataset.Dataset "keysight.ads.dataset.Dataset")[](#keysight.ads.dataset.open_dataset_for_reading "Link to this definition")
...
keysight.ads.dataset.open\_dataset\_for\_read\_write(*path: [PathLike](https://docs.python.org/3/library/os.md#os.PathLike "(in Python v3.13)")*) → [Dataset](#keysight.ads.dataset.Dataset "keysight.ads.dataset.Dataset")[](#keysight.ads.dataset.open_dataset_for_read_write "Link to this definition")
...
keysight.ads.dataset.create\_dataset(*path: [PathLike](https://docs.python.org/3/library/os.md#os.PathLike "(in Python v3.13)")*) → [Dataset](#keysight.ads.dataset.Dataset "keysight.ads.dataset.Dataset")[](#keysight.ads.dataset.create_dataset "Link to this definition")
...
:   Represents an ADS dataset, a file which typically has a `.ds` extension.
    ...
    * [`create_dataset_in_memory()`](#keysight.ads.dataset.create_dataset_in_memory "keysight.ads.dataset.create_dataset_in_memory")
    ...
    create\_varblock\_from\_dataframe(*block\_name: [str](https://docs.python.org/3/library/stdtypes.md#str "(in Python v3.13)")*, *df: [DataFrame](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.html#pandas.DataFrame "(in pandas v2.2.3)")*) → [VariableBlock](#keysight.ads.dataset.VariableBlock "keysight.ads.dataset.VariableBlock")[](#keysight.ads.dataset.Dataset.create_varblock_from_dataframe "Link to this definition")
    ...
    find\_varblocks\_with\_var\_name(*var\_name: [str](https://docs.python.org/3/library/stdtypes.md#str "(in Python v3.13)")*) → [Iterable](https://docs.python.org/3/library/typing.html#typing.Iterable "(in Python v3.13)")[[VariableBlock](#keysight.ads.dataset.VariableBlock "keysight.ads.dataset.VariableBlock")][](#keysight.ads.dataset.Dataset.find_varblocks_with_var_name "Link to this definition")
    ...
    *property* is\_in\_memory\_type*: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")*[](#keysight.ads.dataset.Dataset.is_in_memory_type "Link to this definition")
    :   `True` if the dataset is an in-memory dataset, or
        `False` if it is on disk.

    *property* is\_read\_only*: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")*[](#keysight.ads.dataset.Dataset.is_read_only "Link to this definition")
    :   `True` if the dataset is open for reading only, or
        `False` if modifications are allowed.

    *property* path*: [PathLike](https://docs.python.org/3/library/os.html#os.PathLike "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)")*[](#keysight.ads.dataset.Dataset.path "Link to this definition")
    :   The path to the file on the filesystem, or `None` for
        an in-memory dataset.

    *property* varblock\_names*: [Sequence](https://docs.python.org/3/library/typing.html#typing.Sequence "(in Python v3.13)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")]*[](#keysight.ads.dataset.Dataset.varblock_names "Link to this definition")
    :   The names of variable blocks in the dataset.

        `ds.varblock_names` is equivalent to, and faster than,
        `ds.varblocks.keys()`.

    *property* varblocks*: [Mapping](https://docs.python.org/3/library/typing.html#typing.Mapping "(in Python v3.13)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)"), [VariableBlock](#keysight.ads.dataset.VariableBlock "keysight.ads.dataset.VariableBlock")]*[](#keysight.ads.dataset.Dataset.varblocks "Link to this definition")
...
:   Contains a set of dependent and independent variables.
    ...
    *property* dvars*: [Sequence](https://docs.python.org/3/library/typing.html#typing.Sequence "(in Python v3.13)")[[Variable](#keysight.ads.dataset.Variable "keysight.ads.dataset.Variable")]*[](#keysight.ads.dataset.VariableBlock.dvars "Link to this definition")
    :   The dependent variables.

    *property* dvars\_count*: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*[](#keysight.ads.dataset.VariableBlock.dvars_count "Link to this definition")
    :   The number of dependent variables.

        `vb.dvars_count` is equivalent to, and faster than, `len(vb.dvars)`.

    *property* ivars*: [Sequence](https://docs.python.org/3/library/typing.html#typing.Sequence "(in Python v3.13)")[[Variable](#keysight.ads.dataset.Variable "keysight.ads.dataset.Variable")]*[](#keysight.ads.dataset.VariableBlock.ivars "Link to this definition")
    :   The independent variables.

    *property* ivars\_count*: [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)")*[](#keysight.ads.dataset.VariableBlock.ivars_count "Link to this definition")
    :   The number of independent variables.

        `vb.ivars_count` is equivalent to, and faster than, `len(vb.ivars)`.

    *property* name*: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*[](#keysight.ads.dataset.VariableBlock.name "Link to this definition")
    :   The name of the VariableBlock.

    to\_dataframe(*dvar\_names: [Sequence](https://docs.python.org/3/library/typing.md#typing.Sequence "(in Python v3.13)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")] | [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)") | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)") = None*) → [DataFrame](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.html#pandas.DataFrame "(in pandas v2.2.3)")[](#keysight.ads.dataset.VariableBlock.to_dataframe "Link to this definition")
...
:   A dependent variable or an independent variable inside a VariableBlock.
    ...
    *property* data\_type*: [Type](https://docs.python.org/3/library/typing.html#typing.Type "(in Python v3.13)")[[float](https://docs.python.org/3/library/functions.html#float "(in Python v3.13)") | [complex](https://docs.python.org/3/library/functions.html#complex "(in Python v3.13)") | [int](https://docs.python.org/3/library/functions.html#int "(in Python v3.13)") | [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)") | [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")] | [None](https://docs.python.org/3/library/constants.html#None "(in Python v3.13)")*[](#keysight.ads.dataset.Variable.data_type "Link to this definition")
    :   The data type of the variable’s elements, as a Python type.

        This attribute’s value is a Python type like `int` or `complex`.

    *property* dtype*: [dtype](https://numpy.org/doc/stable/reference/generated/numpy.dtype.html#numpy.dtype "(in NumPy v2.2)") | [ExtensionDtype](https://pandas.pydata.org/docs/reference/api/pandas.api.extensions.ExtensionDtype.html#pandas.api.extensions.ExtensionDtype "(in pandas v2.2.3)")*[](#keysight.ads.dataset.Variable.dtype "Link to this definition")
    ...
    *property* flags*: [Mapping](https://docs.python.org/3/library/typing.html#typing.Mapping "(in Python v3.13)")[[str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)"), [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")]*[](#keysight.ads.dataset.Variable.flags "Link to this definition")
    ...
    *property* is\_indep*: [bool](https://docs.python.org/3/library/functions.html#bool "(in Python v3.13)")*[](#keysight.ads.dataset.Variable.is_indep "Link to this definition")
    :   Indicates whether the variable is an independent (`True`) or
        dependent (`False`).

    *property* name*: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*[](#keysight.ads.dataset.Variable.name "Link to this definition")
    :   The name of the variable.

    *property* variable\_type*: [str](https://docs.python.org/3/library/stdtypes.html#str "(in Python v3.13)")*[](#keysight.ads.dataset.Variable.variable_type "Link to this definition")
...
## 0.9.6 (2024-07-03)[](#id1 "Link to this heading")

* Added support for Python 3.12.

## 0.9.4 (2024-06-28)[](#id2 "Link to this heading")
...
## 0.9.3 (2024-02-26)[](#id3 "Link to this heading")
...
## 0.9.2 (2023-04-19)[](#id4 "Link to this heading")

* Updated requirements to be less strict.
* Added support for Python 3.11.

## 0.9.1 (2022-09-01)[](#id5 "Link to this heading")
...
## 0.9.0 (2022-06-09)[](#id6 "Link to this heading")
