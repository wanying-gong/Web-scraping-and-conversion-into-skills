# Database UU API: keysight.ads.de.db_uu (Design Elements)
> **说明：** UU 单位坐标系下的设计元素 API（最底层布局操作）：db_uu 设计元素完整参考、LayerId（图层标识符）、LineTypeInfo（线型信息）。注：此文件内容较多，包含所有布局元素的详细 API 定义。

> **何时使用：** 当你需要在 UU 坐标系下直接操作布局元素（矩形、多边形、走线、Pin 等）时
...
<!-- === 来源: pypde/docs/reference/de/db_uu/index.md === -->

# keysight.ads.de.db\_uu[](#module-keysight.ads.de.db_uu "Link to this heading")

Database module using user units.

Geometric values read from designs are converted to user units.
Geometric values written to designs are converted to database units.

* [Design Elements](db_uu.md)
  + [Classes](db_uu.md#classes)
  + [Enumerated Types](db_uu.md#enumerated-types)
  + [Functions](db_uu.md#functions)
* [LayerId](layer_id.md)
  + [Classes](layer_id.md#classes)
* [LineTypeInfo](line_type_info.md)
  + [Classes](line_type_info.md#classes)


---

<!-- === 来源: pypde/docs/reference/de/db_uu/db_uu.md === -->
...
<!-- === 来源: pypde/docs/reference/de/db_uu/layer_id.md === -->

# LayerId[](#layerid "Link to this heading")

## Classes[](#classes "Link to this heading")

*class* keysight.ads.de.db\_uu.LayerId[](#keysight.ads.de.db_uu.LayerId "Link to this definition")
:   \_\_init\_\_(*layer: int | None = None*, *purpose: int | None = None*) → None[](#keysight.ads.de.db_uu.LayerId.__init__ "Link to this definition")
    ...
    *classmethod* create\_layer\_id\_from\_library(*library: [Library](../library.md#keysight.ads.de.Library "keysight.ads.de._core.library.Library")*, *layer\_name: str*, *purpose\_name: str | None = None*) → [LayerId](#keysight.ads.de.db_uu.LayerId "keysight.ads.de.db._layer_id.LayerId")[](#keysight.ads.de.db_uu.LayerId.create_layer_id_from_library "Link to this definition")
...
<!-- === 来源: pypde/docs/reference/de/db_uu/line_type_info.md === -->
