# Tech API: keysight.ads.de.tech
> **说明：** 技术层 API：Tech 对象（工艺参数）、Padstacks（焊盘叠层）、Via Rules（过孔规则）、Nested Technology（嵌套工艺）。

> **何时使用：** 当你需要读取或修改工艺/技术文件、焊盘/过孔定义时
...
<!-- === 来源: pypde/docs/reference/de/tech/index.md === -->
...
<!-- === 来源: pypde/docs/reference/de/tech/tech.md === -->
...
<!-- === 来源: pypde/docs/reference/de/tech/pads/pads.md === -->
...
<!-- === 来源: pypde/docs/reference/de/tech/rule/rule.md === -->
...
<!-- === 来源: pypde/docs/reference/de/tech/nested/nested.md === -->
