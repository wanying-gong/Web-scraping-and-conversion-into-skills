<!-- 来源: pypde\docs\reference\de\_autosummary\keysight.ads.de.get_open_writable_library_names.html -->
...
* get\_open\_writable\_library\_names
...
# get\_open\_writable\_library\_names[](#get-open-writable-library-names "Link to this heading")

get\_open\_writable\_library\_names() → set[str][](#keysight.ads.de.get_open_writable_library_names "Link to this definition")

On this page

[Previous

get\_open\_library](keysight.ads.de.get_open_library.md)
[Next

get\_path\_for\_use\_in\_library\_definition\_file](keysight.ads.de.get_path_for_use_in_library_definition_file.md)
