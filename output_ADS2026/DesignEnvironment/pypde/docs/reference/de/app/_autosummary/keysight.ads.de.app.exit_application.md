<!-- 来源: pypde\docs\reference\de\app\_autosummary\keysight.ads.de.app.exit_application.html -->
...
# exit\_application[](#exit-application "Link to this heading")

exit\_application(*exit\_code: int = 0*) → None[](#keysight.ads.de.app.exit_application "Link to this definition")
...
Application](keysight.ads.de.app.Application.md)
[Next

prompt\_and\_save\_modified\_workspace](keysight.ads.de.app.prompt_and_save_modified_workspace.md)
