...
:   \_\_init\_\_(*callback: Callable[[QMenu, [DDSFile](../file.md#keysight.ads.dds.DDSFile "keysight.ads.dds.core.ddobj.DDSFile"), [Window](../windows.md#keysight.ads.dds.Window "keysight.ads.dds.core.ddwin.Window"), [Point](../point.md#keysight.ads.dds.Point "keysight.ads.dds.core.ddgeom.Point")], None]*) → None[](#keysight.ads.dds.app.PopupCallback.__init__ "Link to this definition")
...
:   Class that contains color information.
    ...
    \_\_init\_\_(*index: int*) → None[](#keysight.ads.dds.Color.__init__ "Link to this definition")

    \_\_init\_\_(*rgb: tuple[int, int, int]*) → None

    \_\_init\_\_(*\**, *index: int = None*, *rgb: tuple[int, int, int] = None*) → None
    ...
    *static* invalid\_color() → [Color](#keysight.ads.dds.Color "keysight.ads.dds.core.ddbase.Color")[](#keysight.ads.dds.Color.invalid_color "Link to this definition")
    :   Return an invalid color which may hide objects that support it.
...
:   Class that contains properties for fill patterns.
    ...
    \_\_init\_\_(*pattern: str | None = None*, *color: [Color](#keysight.ads.dds.Color "keysight.ads.dds.core.ddbase.Color") | None = None*) → None[](#keysight.ads.dds.FillProperties.__init__ "Link to this definition")
    ...
    *static* fill\_patterns() → list[str][](#keysight.ads.dds.FillProperties.fill_patterns "Link to this definition")
    :   Return a list of patterns.
        ...
        ```
        >>> from keysight.ads import dds as dds
        >>> dds.FillProperties.fill_patterns()
        ```
...
:   Class that contains properties for lines.
    ...
    \_\_init\_\_(*type: [LineType](#keysight.ads.dds.LineType "keysight.ads.dds.core.ddbase.LineType") | str | None = None*, *color: [Color](#keysight.ads.dds.Color "keysight.ads.dds.core.ddbase.Color") | None = None*, *width: float | None = None*) → None[](#keysight.ads.dds.LineProperties.__init__ "Link to this definition")
    :   Create an instance of LineProperties.

        Parameters:
        :   * **type** ([*LineType*](#keysight.ads.dds.LineType "keysight.ads.dds.LineType") *|* *str* *[**optional**,* *default=None**]*) – Any value other than a value from class:LineType will throw an exception.
            * **color** ([*Color*](#keysight.ads.dds.Color "keysight.ads.dds.Color") *[**optional**,* *default=None**]*) – If a valid Color is passed, the fill pattern will be drawn in the specified color. If no color is specified (value == None), then
              the fill pattern will be drawn in black. If an invalid color is specified, an exception is thrown.
        ...
        :   * **RuntimeError: Invalid color index "<int>" specified. Color index must be between "0" and "<int>".** – The integer parameter is out of bounds of the available colors.
            * **RuntimeError: Unable to find color r={<int>}****,** **g={<int>}****,** **b={<int>}.** – The tuple parameter does not match any available colors.
            * **RuntimeError: LineType has no value** – <str>.: The string passed to the type parameter does not correspond to a valid LineType value.
        ...
        >>> center = dds.Point(500, 500)
        >>> obj = page.add_circle(center, 100)
        >>> obj.line_properties = dds.LineProperties(dds.LineType.LONG_DASH, dds.Color(3), 2.7)
        >>> print(obj.line_properties)
            <LineProperties type="long_dash" color=<Color "3"> width=-2.7>
        ```
...
:   Class that contains properties for text.
    ...
    The Data Display default font can be obtained by the method :meth:’get\_default\_font’.
    Individual fonts can be obtained by indexing into the fonts list with a string.

    \_\_init\_\_(*font: str | None = None*, *color: [Color](#keysight.ads.dds.Color "keysight.ads.dds.core.ddbase.Color") | None = None*, *size: int | None = None*) → None[](#keysight.ads.dds.TextProperties.__init__ "Link to this definition")
...
:   \_\_init\_\_(*format: [StringFormatOption](#keysight.ads.dds.StringFormatOption "keysight.ads.dds.core.ddbase.StringFormatOption") | str | None = None*, *significant\_digits: int | None = 6*, *units\_format: [UnitsStringOption](#keysight.ads.dds.UnitsStringOption "keysight.ads.dds.core.ddbase.UnitsStringOption") | str | None = None*, *complex\_format: [ComplexStringFormatOption](#keysight.ads.dds.ComplexStringFormatOption "keysight.ads.dds.core.ddbase.ComplexStringFormatOption") | str | None = None*) → None[](#keysight.ads.dds.StringFormat.__init__ "Link to this definition")

    *property* complex\_format*: [ComplexStringFormatOption](#keysight.ads.dds.ComplexStringFormatOption "keysight.ads.dds.core.ddbase.ComplexStringFormatOption")*[](#keysight.ads.dds.StringFormat.complex_format "Link to this definition")

    *property* digits*: int*[](#keysight.ads.dds.StringFormat.digits "Link to this definition")
    :   significant\_digits

        Type:
        :   digits is deprecated, and will be removed in the 2026 Update 2 release. Use

    *property* format*: [StringFormatOption](#keysight.ads.dds.StringFormatOption "keysight.ads.dds.core.ddbase.StringFormatOption")*[](#keysight.ads.dds.StringFormat.format "Link to this definition")

    *property* significant\_digits*: int*[](#keysight.ads.dds.StringFormat.significant_digits "Link to this definition")

    *property* units\_format*: [UnitsStringOption](#keysight.ads.dds.UnitsStringOption "keysight.ads.dds.core.ddbase.UnitsStringOption")*[](#keysight.ads.dds.StringFormat.units_format "Link to this definition")

*class* keysight.ads.dds.StringFormatOption[](#keysight.ads.dds.StringFormatOption "Link to this definition")
:   AUTOMATIC *= <FormatOption.AUTOMATIC: 0>*[](#keysight.ads.dds.StringFormatOption.AUTOMATIC "Link to this definition")

    BINARY *= <FormatOption.BINARY: 6>*[](#keysight.ads.dds.StringFormatOption.BINARY "Link to this definition")

    ENGINEERING *= <FormatOption.ENGINEERING: 3>*[](#keysight.ads.dds.StringFormatOption.ENGINEERING "Link to this definition")

    FULL *= <FormatOption.FULL: 1>*[](#keysight.ads.dds.StringFormatOption.FULL "Link to this definition")

    FULL\_OR\_SCIENTIFIC *= <FormatOption.FULL\_OR\_SCIENTIFIC: 7>*[](#keysight.ads.dds.StringFormatOption.FULL_OR_SCIENTIFIC "Link to this definition")

    HEX *= <FormatOption.HEX: 4>*[](#keysight.ads.dds.StringFormatOption.HEX "Link to this definition")

    OCTAL *= <FormatOption.OCTAL: 5>*[](#keysight.ads.dds.StringFormatOption.OCTAL "Link to this definition")

    SCIENTIFIC *= <FormatOption.SCIENTIFIC: 2>*[](#keysight.ads.dds.StringFormatOption.SCIENTIFIC "Link to this definition")

    *property* str*: str*[](#keysight.ads.dds.StringFormatOption.str "Link to this definition")

*class* keysight.ads.dds.ComplexStringFormatOption[](#keysight.ads.dds.ComplexStringFormatOption "Link to this definition")
:   DB\_PHASE *= <ComplexFormatOption.DB\_PHASE: 2>*[](#keysight.ads.dds.ComplexStringFormatOption.DB_PHASE "Link to this definition")

    DB\_RADIANS *= <ComplexFormatOption.DB\_RADIANS: 4>*[](#keysight.ads.dds.ComplexStringFormatOption.DB_RADIANS "Link to this definition")

    MAG\_PHASE *= <ComplexFormatOption.MAG\_PHASE: 1>*[](#keysight.ads.dds.ComplexStringFormatOption.MAG_PHASE "Link to this definition")

    MAG\_RADIANS *= <ComplexFormatOption.MAG\_RADIANS: 3>*[](#keysight.ads.dds.ComplexStringFormatOption.MAG_RADIANS "Link to this definition")

    REAL\_IMAGINARY *= <ComplexFormatOption.REAL\_IMAGINARY: 0>*[](#keysight.ads.dds.ComplexStringFormatOption.REAL_IMAGINARY "Link to this definition")

    *property* str*: str*[](#keysight.ads.dds.ComplexStringFormatOption.str "Link to this definition")

*class* keysight.ads.dds.UnitsStringOption[](#keysight.ads.dds.UnitsStringOption "Link to this definition")
:   AUTOMATIC *= <UnitsOption.AUTOMATIC: 0>*[](#keysight.ads.dds.UnitsStringOption.AUTOMATIC "Link to this definition")

    DONT\_INCLUDE\_UNITS *= <UnitsOption.DONT\_INCLUDE\_UNITS: 2>*[](#keysight.ads.dds.UnitsStringOption.DONT_INCLUDE_UNITS "Link to this definition")

    INCLUDE\_UNITS *= <UnitsOption.INCLUDE\_UNITS: 1>*[](#keysight.ads.dds.UnitsStringOption.INCLUDE_UNITS "Link to this definition")

    *property* str*: str*[](#keysight.ads.dds.UnitsStringOption.str "Link to this definition")
...
:   Equations perform complex mathematical operations on data.
    ...
    \_\_init\_\_(*\*args*, *\*\*kwargs*) → None[](#keysight.ads.dds.Equation.__init__ "Link to this definition")
    ...
    *property* uid*: int*[](#keysight.ads.dds.Equation.uid "Link to this definition")
...
<!-- === 来源: reference/dds/experimental/qtwidget.md === -->
...
:   Objects grouped together.
    ...
    \_\_init\_\_(*\*args*, *\*\*kwargs*) → None[](#keysight.ads.dds.Group.__init__ "Link to this definition")
    ...
    *property* objects*: Sequence[GraphicalObject]*[](#keysight.ads.dds.Group.objects "Link to this definition")

    *property* type*: ObjectType*[](#keysight.ads.dds.Group.type "Link to this definition")

    *property* uid*: int*[](#keysight.ads.dds.Group.uid "Link to this definition")
...
* [Axes](axes.md)
  ...
  + [`AxisOrientation`](axes.md#keysight.ads.dds.AxisOrientation)
  + [`AxisTextProperties`](axes.md#keysight.ads.dds.AxisTextProperties)
* [Legend](legend.md)
...
* [Trace](trace.md)
  ...
  + [`AutoSequenceSettings`](trace.md#keysight.ads.dds.AutoSequenceSettings)
  + [`DensitySymbolType`](trace.md#keysight.ads.dds.DensitySymbolType)
  + [`TraceLabelProperties`](trace.md#keysight.ads.dds.TraceLabelProperties)
  + [`SymbolSpacing`](trace.md#keysight.ads.dds.SymbolSpacing)
  + [`SymbolType`](trace.md#keysight.ads.dds.SymbolType)
  + [`TraceType`](trace.md#keysight.ads.dds.TraceType)
* [Markers](marker.md)
...
* [Common Properties](basic.md)
  ...
  + [`StringFormatOption`](basic.md#keysight.ads.dds.StringFormatOption)
  + [`ComplexStringFormatOption`](basic.md#keysight.ads.dds.ComplexStringFormatOption)
  + [`UnitsStringOption`](basic.md#keysight.ads.dds.UnitsStringOption)
* [Print](print.md)
...
:   Close a DDSFile.
    ...
    [`DDSFile.close()`](file.md#keysight.ads.dds.DDSFile.close "keysight.ads.dds.DDSFile.close")
    :   Close a DDSFile that can raise an error if the file is modified.
...
:   Limit lines provide an object that indicates a desired expectation of the trace data.
    ...
    \_\_init\_\_(*\*args*, *\*\*kwargs*) → None[](#keysight.ads.dds.LimitLine.__init__ "Link to this definition")
    ...
    *property* errors*: str*[](#keysight.ads.dds.LimitLine.errors "Link to this definition")
    :   The current errors for the data points expression.

    *property* expression*: str*[](#keysight.ads.dds.LimitLine.expression "Link to this definition")
    :   The name of the pass/fail expression.

        expression is deprecated, and will be removed in the 2027 release. Use: pass\_fail\_expression\_name
    ...
    *property* fail\_line\_properties*: [LineProperties](basic.md#keysight.ads.dds.LineProperties "keysight.ads.dds.core.ddbase.LineProperties")*[](#keysight.ads.dds.LimitLine.fail_line_properties "Link to this definition")
    :   Line properties used when failing the data violation test.
    ...
    *property* is\_valid*: bool*[](#keysight.ads.dds.LimitLine.is_valid "Link to this definition")
    :   Is the objects data points expression valid.
    ...
    *property* line\_properties*: [LineProperties](basic.md#keysight.ads.dds.LineProperties "keysight.ads.dds.core.ddbase.LineProperties")*[](#keysight.ads.dds.LimitLine.line_properties "Link to this definition")
    :   Line properties used when passing the data violation test.

        line\_properties is deprecated, and will be removed in the 2027 release. Use: pass\_line\_properties
    ...
    *property* pass\_fail\_expression\_name*: str*[](#keysight.ads.dds.LimitLine.pass_fail_expression_name "Link to this definition")

    *property* pass\_line\_properties*: [LineProperties](basic.md#keysight.ads.dds.LineProperties "keysight.ads.dds.core.ddbase.LineProperties")*[](#keysight.ads.dds.LimitLine.pass_line_properties "Link to this definition")
    :   Line properties used when passing the data violation test.

    *property* status*: str*[](#keysight.ads.dds.LimitLine.status "Link to this definition")
    :   The current status of the data points expression.

        Each data point is validated separately to identify which data
        point is valid or invalid. In some cases an invalid data
        point is referencing an expression that will be defined later
        by the user or from simulation results.
    ...
    *property* uid*: int*[](#keysight.ads.dds.LimitLine.uid "Link to this definition")
...
:   A line marker displays all trace values at a specific independent value.
    ...
    \_\_init\_\_(*\*args*, *\*\*kwargs*) → None[](#keysight.ads.dds.LineMarker.__init__ "Link to this definition")
    ...
    *property* label\_text\_properties*: [TextProperties](basic.md#keysight.ads.dds.TextProperties "keysight.ads.dds.core.ddbase.TextProperties")*[](#keysight.ads.dds.LineMarker.label_text_properties "Link to this definition")
    ...
    *property* readout\_bbox*: [Rect](rect.md#keysight.ads.dds.Rect "keysight.ads.dds.core.ddgeom.Rect")*[](#keysight.ads.dds.LineMarker.readout_bbox "Link to this definition")
    ...
    *property* readout\_fill\_properties*: [FillProperties](basic.md#keysight.ads.dds.FillProperties "keysight.ads.dds.core.ddbase.FillProperties")*[](#keysight.ads.dds.LineMarker.readout_fill_properties "Link to this definition")

    readout\_move(*delta: [Point](point.md#keysight.ads.dds.Point "keysight.ads.dds.core.ddgeom.Point") | tuple[int, int]*) → None[](#keysight.ads.dds.LineMarker.readout_move "Link to this definition")

    *property* readout\_outline\_on*: bool*[](#keysight.ads.dds.LineMarker.readout_outline_on "Link to this definition")

    *property* readout\_text\_properties*: [TextProperties](basic.md#keysight.ads.dds.TextProperties "keysight.ads.dds.core.ddbase.TextProperties")*[](#keysight.ads.dds.LineMarker.readout_text_properties "Link to this definition")
    ...
    *property* uid*: int*[](#keysight.ads.dds.LineMarker.uid "Link to this definition")
...
:   \_\_init\_\_(*color: [Color](basic.md#keysight.ads.dds.Color "keysight.ads.dds.core.ddbase.Color") | None = None*, *size: int | None = None*) → None[](#keysight.ads.dds.LineMarkerSymbolProperties.__init__ "Link to this definition")
...
:   Line mask on a plot.
    ...
    \_\_init\_\_(*\*args*, *\*\*kwargs*) → None[](#keysight.ads.dds.LineMask.__init__ "Link to this definition")
    ...
    *property* errors*: str*[](#keysight.ads.dds.LineMask.errors "Link to this definition")
    :   The current errors for the data points expression.
    ...
    *property* is\_valid*: bool*[](#keysight.ads.dds.LineMask.is_valid "Link to this definition")
    :   Is the objects data points expression valid.
    ...
    *property* status*: str*[](#keysight.ads.dds.LineMask.status "Link to this definition")
    :   The current status of the data points expression.
    ...
    *property* uid*: int*[](#keysight.ads.dds.LineMask.uid "Link to this definition")
...
:   Polygon mask on a plot.
    ...
    \_\_init\_\_(*\*args*, *\*\*kwargs*) → None[](#keysight.ads.dds.PolygonMask.__init__ "Link to this definition")
    ...
    *property* errors*: str*[](#keysight.ads.dds.PolygonMask.errors "Link to this definition")
    :   The current errors for the data points expression.
    ...
    *property* is\_valid*: bool*[](#keysight.ads.dds.PolygonMask.is_valid "Link to this definition")
    :   Is the objects data points expression valid.
    ...
    *property* status*: str*[](#keysight.ads.dds.PolygonMask.status "Link to this definition")
    :   The current status of the data points expression.
    ...
    *property* uid*: int*[](#keysight.ads.dds.PolygonMask.uid "Link to this definition")
...
:   Polyline mask on a plot.
    ...
    \_\_init\_\_(*\*args*, *\*\*kwargs*) → None[](#keysight.ads.dds.PolylineMask.__init__ "Link to this definition")
    ...
    *property* errors*: str*[](#keysight.ads.dds.PolylineMask.errors "Link to this definition")
    :   The current errors for the data points expression.
    ...
    *property* is\_valid*: bool*[](#keysight.ads.dds.PolylineMask.is_valid "Link to this definition")
    :   Is the objects data points expression valid.
    ...
    *property* status*: str*[](#keysight.ads.dds.PolylineMask.status "Link to this definition")
    :   The current status of the data points expression.
    ...
    *property* uid*: int*[](#keysight.ads.dds.PolylineMask.uid "Link to this definition")
...
:   Rectangle mask on a plot.
    ...
    \_\_init\_\_(*\*args*, *\*\*kwargs*) → None[](#keysight.ads.dds.RectMask.__init__ "Link to this definition")
    ...
    *property* errors*: str*[](#keysight.ads.dds.RectMask.errors "Link to this definition")
    :   The current errors for the data points expression.
    ...
    *property* is\_valid*: bool*[](#keysight.ads.dds.RectMask.is_valid "Link to this definition")
    :   Is the objects data points expression valid.
    ...
    *property* status*: str*[](#keysight.ads.dds.RectMask.status "Link to this definition")
    :   The current status of the data points expression.
    ...
    *property* uid*: int*[](#keysight.ads.dds.RectMask.uid "Link to this definition")
...
:   A page is an area to organize Data Display objects that can be viewed in windows.
    ...
    >>> from keysight.ads import dds as dds
    >>> dds_file = dds.new_dds_file()
    >>> myPage = dds_file.new_page("myPage")
    >>> print(dds_file.pages)
        (<Page "myPage">, <Page "page 1">)
    >>> dds_file.save()
    ```

    \_\_init\_\_(*\*args*, *\*\*kwargs*) → None[](#keysight.ads.dds.Page.__init__ "Link to this definition")
    ...
    add\_equation(*name: str*, *value: str*, */*, *location: TPoint | None = None*) → [Equation](equation.md#keysight.ads.dds.Equation "keysight.ads.dds.Equation")[](#keysight.ads.dds.Page.add_equation "Link to this definition")

    add\_equation(*expression: str*, *location: TPoint | None = None*, */*) → [Equation](equation.md#keysight.ads.dds.Equation "keysight.ads.dds.Equation")
    :   Add an equation to the page.
        ...
        :   * **expression\_or\_name** (*name - str**,* *value -str* *|* *expressions : str*) – An expression can be specified by two strings, e.g. “x” and “S11”, or by one string, e.g. “x = S11”
            * **Location** ([*Point*](point.md#keysight.ads.dds.Point "keysight.ads.dds.Point") *|* *tuple**[**int**,**int**]* *[**optional**,* *default = None**]*) – Coordinates of where to place the top\_left corner of the equation on the page. The point may be modified
              to the next closest grid point if snapping is enabled. Also, the point may be modified if another object
              is already placed at that location.
    ...
    add\_picture(*path: str | PathLike*, *rect: [Rect](rect.md#keysight.ads.dds.Rect "keysight.ads.dds.core.ddgeom.Rect")*) → [Picture](picture.md#keysight.ads.dds.Picture "keysight.ads.dds.core.ddshape.Picture")[](#keysight.ads.dds.Page.add_picture "Link to this definition")
    ...
    :   Add a PySide widget wrapped into a Data Display graphical object.
    ...
    *property* objects*: list[GraphicalObject]*[](#keysight.ads.dds.Page.objects "Link to this definition")
    ...
    placement\_mode(*\*\*settings\_kwargs: PlacementModeType | str | int*) → PlacementContext[](#keysight.ads.dds.Page.placement_mode "Link to this definition")
    :   Context manager for temporarily setting placement mode on this page.

        This allows you to temporarily override placement settings for a block of code,
        after which the previous settings are automatically restored. To permanently set
        placement settings, use the [`placement_settings`](#keysight.ads.dds.Page.placement_settings "keysight.ads.dds.Page.placement_settings") property.

        Parameters:
        :   * **equation\_mode** (*PlacementModeType**,* *optional*) – Placement mode for equations
            * **plot\_mode** (*PlacementModeType**,* *optional*) – Placement mode for plots
            * **maxRows** (*int**,* *optional*) – Maximum number of rows per column
            * **maxColumns** (*int**,* *optional*) – Maximum number of columns

        Returns:
        :   A context manager that temporarily applies the specified settings
        ...
        Use FORCE\_EXACT mode temporarily for a few equations:

        ```
        >>> page = dds_file.pages[0]
        >>> with page.placement_mode(equation_mode=dds.PlacementModeType.FORCE_EXACT):
        ...     page.add_equation("eq1", "S(1,1)")
        ...     page.add_equation("eq2", "S(2,1)")
        >>> # Settings automatically restored after exiting the context
        ```

    *property* placement\_settings*: PlacementSettings*[](#keysight.ads.dds.Page.placement_settings "Link to this definition")
    ...
    *property* selected\_objects*: list[GraphicalObject]*[](#keysight.ads.dds.Page.selected_objects "Link to this definition")
    :   A list of selected objects on a page.
        ...
        >>> dds_file = dds.open_dds_file("test.dds")
        >>> page = dds_file.pages[0]
        >>> sel_objs = page.selected_objects
        >>> print(sel_objs)
            []
        >>> objs = page.objects
        >>> print(objs)
    ...
    *property* uid*: int*[](#keysight.ads.dds.Page.uid "Link to this definition")
...
:   An image on a page.
    ...
    \_\_init\_\_(*\*args*, *\*\*kwargs*) → None[](#keysight.ads.dds.Picture.__init__ "Link to this definition")
    ...
    *property* errors*: str*[](#keysight.ads.dds.Picture.errors "Link to this definition")
    ...
    *property* lock\_aspect\_ratio*: bool*[](#keysight.ads.dds.Picture.lock_aspect_ratio "Link to this definition")
    ...
    *property* name*: str*[](#keysight.ads.dds.Picture.name "Link to this definition")
    ...
    reset\_aspect\_ratio() → None[](#keysight.ads.dds.Picture.reset_aspect_ratio "Link to this definition")

    reset\_size() → None[](#keysight.ads.dds.Picture.reset_size "Link to this definition")

    *property* save\_to\_workspace*: bool*[](#keysight.ads.dds.Picture.save_to_workspace "Link to this definition")

    *property* type*: ObjectType*[](#keysight.ads.dds.Picture.type "Link to this definition")

    *property* uid*: int*[](#keysight.ads.dds.Picture.uid "Link to this definition")
...
:   Python Equations execute python statements with dependency tracking between other equations.
    ...
    \_\_init\_\_(*\*args*, *\*\*kwargs*) → None[](#keysight.ads.dds.PyEquation.__init__ "Link to this definition")
    ...
    *property* uid*: int*[](#keysight.ads.dds.PyEquation.uid "Link to this definition")
...
:   A simple rectangle defined by top, left, bottom, right values.
    ...
    \_\_init\_\_(*\**, *top: int | None = None*, *left: int | None = None*, *bottom: int | None = None*, *right: int | None = None*, *top\_left: [Point](point.md#keysight.ads.dds.Point "keysight.ads.dds.core.ddgeom.Point") | tuple[int, int] | None = None*, *bottom\_right: [Point](point.md#keysight.ads.dds.Point "keysight.ads.dds.core.ddgeom.Point") | tuple[int, int] | None = None*, *width: int | None = None*, *height: int | None = None*) → None[](#keysight.ads.dds.Rect.__init__ "Link to this definition")
    :   Initialize an instance of Rect.
...
:   A group of limit lines and masks.
    ...
    \_\_init\_\_(*\*args*, *\*\*kwargs*) → None[](#keysight.ads.dds.Specification.__init__ "Link to this definition")
    ...
    *property* ignore\_limitline\_and\_mask\_locks*: bool*[](#keysight.ads.dds.Specification.ignore_limitline_and_mask_locks "Link to this definition")

    *property* is\_locked*: bool*[](#keysight.ads.dds.Specification.is_locked "Link to this definition")
    ...
    *property* objects*: Sequence[PlotGraphicalObject]*[](#keysight.ads.dds.Specification.objects "Link to this definition")

    *property* pass\_fail\_expression\_name*: str*[](#keysight.ads.dds.Specification.pass_fail_expression_name "Link to this definition")

    *property* type*: ObjectType*[](#keysight.ads.dds.Specification.type "Link to this definition")

    *property* uid*: int*[](#keysight.ads.dds.Specification.uid "Link to this definition")
...
* [keysight.ads.dds.experimental](dds/experimental/index.md)
  + [Classes](dds/experimental/index.md#classes)
    - [DDSQtWidget](dds/experimental/qtwidget.md)
  + [Functions](dds/experimental/index.md#functions)
    - [`rename_dataset_and_update_expressions()`](dds/experimental/index.md#keysight.ads.dds.experimental.rename_dataset_and_update_expressions)
* [keysight.ads.dds.app](dds/app/index.md)
  ...
  + [Functions](dds/app/index.md#functions)
    - [`get_pyside_main_window()`](dds/app/index.md#keysight.ads.dds.app.get_pyside_main_window)
