...
> 本知识库来自 Keysight ADS 2026 Update 2.1 DDS Python Documentation HTML 文档，经 MarkItDown 转换并按主题自动分类整理，专为 AI Agent 按需加载设计。
...
| `03_appexamples.md` | Appexamples | ~5 KB |
| `04_concepts.md` | Concepts | ~4 KB |
| `05_examples.md` | Examples | ~29 KB |
| `06_howto.md` | Howto | ~6 KB |
| `07_intro.md` | Intro | ~4 KB |
| `08_reference.md` | Reference | ~381 KB |
...
原始转换文件保存在 `D:\MarkitdownFull\output_ADS2026\DDS` 目录下（按原 HTML 目录结构镜像），可用于查阅具体细节。本 `skills/` 目录下的文件是按主题合并的精简版本。
