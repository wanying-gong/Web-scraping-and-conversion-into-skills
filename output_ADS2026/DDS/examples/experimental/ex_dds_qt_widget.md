<!-- 来源: examples\experimental\ex_dds_qt_widget.html -->

[![Logo](../../_static/images/keysight_logo.svg)](http://www.keysight.com/)

* [DDS Python Documentation](../../index.md)
* [Examples](../index.md)
* [Experimental Examples](index.md)
* DDS Qt Widget displayed in a Qt QDialog
...
* [Examples](../index.md)
  ...
  + [Experimental Examples](index.md)
    - DDS Qt Widget displayed in a Qt QDialog
    - [DDS Qt Widget printed using a Qt QPrinter](#dds-qt-widget-printed-using-a-qt-qprinter)
    - [DDS Qt Widget output to a Qt QPixmap](#dds-qt-widget-output-to-a-qt-qpixmap)
