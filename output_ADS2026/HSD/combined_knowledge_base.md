# High Speed Digital Python Documentation Knowledge Base
> 本文件由 MarkItDown 自动转换，BFS 遍历自 Keysight ADS2026 Update 2.1 High Speed Digital Python Documentation HTML 文档。
> 共 28 个页面。
...
3. [intro\vscode.md](#intro--vscode)
4. [reference\index.md](#reference--index)
5. [reference\hsd\index.md](#reference--hsd--index)
6. [reference\hsd\core.md](#reference--hsd--core)
7. [reference\hsd\metadata.md](#reference--hsd--metadata)
8. [reference\hsd\smartwire.md](#reference--hsd--smartwire)
9. [reference\hsd\memory\index.md](#reference--hsd--memory--index)
10. [reference\hsd\memory\setup.md](#reference--hsd--memory--setup)
11. [reference\hsd\memory\prelayout.md](#reference--hsd--memory--prelayout)
12. [reference\hsd\memory\pcb.md](#reference--hsd--memory--pcb)
13. [reference\hsd\memory\bus_tline.md](#reference--hsd--memory--bus_tline)
14. [reference\hsd\memory\bus_designer.md](#reference--hsd--memory--bus_designer)
15. [reference\hsd\memory\ddr_controller.md](#reference--hsd--memory--ddr_controller)
16. [reference\hsd\memory\ddr_memory.md](#reference--hsd--memory--ddr_memory)
17. [reference\hsd\memory\simulator.md](#reference--hsd--memory--simulator)
18. [reference\hsd\memory\probe.md](#reference--hsd--memory--probe)
19. [reference\hsd\memory\ddr_termination.md](#reference--hsd--memory--ddr_termination)
20. [reference\hsd\memory\io_component.md](#reference--hsd--memory--io_component)
21. [howto\index.md](#howto--index)
22. [howto\venv.md](#howto--venv)
23. [howto\newvenv.md](#howto--newvenv)
24. [howto\existingvenv.md](#howto--existingvenv)
25. [howto\pytest.md](#howto--pytest)
26. [examples\index.md](#examples--index)
27. [examples\pcb_setup.md](#examples--pcb_setup)
28. [examples\sample_design.md](#examples--sample_design)
...
# Python High Speed Design (pyhsd) documentation (Beta)[](#python-high-speed-design-pyhsd-documentation-beta "Link to this heading")
